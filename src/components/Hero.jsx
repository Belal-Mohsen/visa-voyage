...
const Hero = () => {
  return (
    ...
    <div className='absolute top-0 w-full h-full flex flex-col justify-center text-center text-white p-4'>
      <h1> Travel for visits, work, study, or treatment </h1>
      <h2>with ease through VISA VOYAGE.</h2>
      <form className='flex justify-between border items-center max-w-[800px] mx-auto p-1
      rounded-md text-black bg-gray-100/90'>
        ...
        <div>
          <button><AiOutlineSearch size={20} className='icon srch-icon'/></button>
        </div>
